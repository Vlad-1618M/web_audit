# Screenshot captures for SWIFT_APP_GUIDE.md

Add PNGs here when you walk through the app. Filenames expected by the guide:

| File | Screen |
|------|--------|
| `01-ready.png` | Ready home — URL, feature grid, About panel |
| `02-scanning.png` | Scanning — live log |
| `03-complete.png` | Report ready — scores, chips, fix-first |
