...
def test_siteground_captcha_page():
    """Ensures Siteground Captcha Page."""
    body = '<html><head><link rel="icon" href="data:;"><meta http-equiv="refresh" content="0;/.well-known/sgcaptcha/?r=%2F"></meta></head></html>'
    assert is_bot_challenge(body, status_code=202) is True

def test_normal_homepage_not_challenge():
    """Ensures Normal Homepage Not Challenge."""
