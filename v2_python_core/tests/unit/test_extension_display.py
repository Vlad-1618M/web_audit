...
def test_build_extension_section_django():
    findings = [
        Finding.from_check(
            ...
            detail="django 4.2.0 is behind latest 5.2.0",
            evidence={"name": "django", "version": "4.2.0", "latest": "5.2.0", "registry": "pypi"},
        )
    ]
    section = build_extension_section(
        {
            "extensions": {
                "framework": "django",
                "unit": "package",
                "extensions": [{"name": "django", "version": "4.2.0", "source": "debug_page", "unit": "package"}],
            }
        },
        findings,
        framework="django",
