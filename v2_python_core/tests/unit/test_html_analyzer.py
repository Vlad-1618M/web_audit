...
def test_mixed_content_on_https_is_scored():
    """Ensures Mixed Content On Https Is Scored."""
    html = '\n    <html><body>\n      <img src="http://example.com/insecure.png">\n      <a href="/about">About</a>\n    </body></html>\n    '
    probe = HtmlProbeResult(target_url='https://example.com', body=html, pages_scanned=1, inventory=parse_html_inventory(html, target_url='https://example.com'))
...
def test_internal_link_inventory_info():
    """Ensures Internal Link Inventory Info."""
...
def test_bot_challenge_homepage_emits_verify_finding():
    """Ensures Bot Challenge Homepage Emits Verify Finding."""
    probe = HtmlProbeResult(target_url='https://example.com', body='<html><meta http-equiv="refresh" content="0;/.well-known/sgcaptcha/"></html>', pages_scanned=0, bot_challenge=True, http_status=202)
    findings = analyze_html(probe, HtmlCollectorSettings())
