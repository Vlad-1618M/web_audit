...
RAW_BROWSER_MISSING = (
    ...
    "/Users/vtool/Library/Caches/ms-playwright/chromium_headless_shell-1223/"
...
def test_js_section_legacy_raw_error_in_artifact():
    section = build_js_section(
        {
            "inventory": {
                "html": {"inventory": {"link_count": 5}},
                "js": {"error": RAW_BROWSER_MISSING, "link_count": 0},
            }
        },
        target_url="https://muzar.io",
    )
...
def test_js_error_from_artifact_prefers_normalized_fields():
    info = js_error_from_artifact(
        {
            "error_code": "browser_missing",
            "error_message": "Chromium missing.",
            "fix_steps": ["playwright install chromium"],
            "error_raw": RAW_BROWSER_MISSING,
        },
